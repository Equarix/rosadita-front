    ...
    <div className="relative overflow-hidden bg-white">
      <div className="relative max-w-7xl mx-auto px-1 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center ">
            <div className="relative w-[480px] h-[300px] rounded-2xl overflow-hidden hover:shadow-2xl transition ">
              <Image
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 transition max-w-7xl mx-auto">
          <div className="w-[350px] bg-white rounded-2xl shadow-lg p-6 flex flex-col overflow-hidden hover:shadow-2xl transition ">
